...
//            BottomSheetHelper.createBottomSheet(mBottomSheetBehavior, Message);
            FirebaseHelper.signUpWithNumber(phoneNumber);
//            Intent intent = new Intent(getContext(), RegisterUserActivity.class);
////            #TODO send the number over the intent - Send the intent inside the FirebaseHelper
//            intent.putExtra(getString(R.string.number), phoneNumber);
//            getActivity().startActivity(intent);
